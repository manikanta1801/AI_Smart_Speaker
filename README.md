...
5. Paste your Netlify URL followed by `/.netlify/functions/gemini-webhook`. 
   - Example: `https://your-site.netlify.app/.netlify/functions/gemini-webhook`
6. Click **Save**.
...
Open `netlify/functions/gemini-webhook.js` and modify the `SYSTEM_PROMPT` variable to give your AI a different personality or rules!
